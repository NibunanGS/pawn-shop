...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/nibunan/Work/Projects/Personal/pawn-shop/OriginalDB.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'yf!l_+hrn@&j19tz)mqfp$zg!r_z7&k8%^l=e_c3ybebph!iph'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    "/Users/nibunan/Work/Projects/Personal/pawn-shop/PawnShopTemplates",
)
